...
- 支持采集固定奖金完整变化轨迹、官方详情页伤停和新赛季技术资料；缺失字段明确标记，不伪造正式首发。
...
sporttery collect-prematch --date 2026-09-04 --output data/raw/prematch/2026-09-04/210000Z.json
```
...
赛前快照字段、首发边界和运行方式见 [赛前数据采集](docs/PREMATCH_COLLECTION.md)。
